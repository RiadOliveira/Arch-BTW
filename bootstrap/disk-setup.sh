...
efibootmgr --create --disk "/dev/$EFI_DISK" --part 1 --label "KeyTool" --loader '\EFI\KeyTool.efi'

efibootmgr --create --disk "/dev/$EFI_DISK" --part 1 --label "Arch Linux" --loader '\EFI\systemd\systemd-bootx64.efi'
